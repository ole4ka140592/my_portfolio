            ...
            <div className={`${styleContainer.container} ${style.footerContainer}`}>
                ...
                <div className={style.footers}>
                    <div className={style.footer}>
                        ...
                        <img src={facebookImage} alt="facebook" className={style.icon}/>
                        </a>
                    </div>
                    <div className={style.footer}>
                        <a href='https://www.linkedin.com/in/olga-mitsiurova-214181232/'>
                            <img src={linkedinImage} alt="linkedin" className={style.icon}/>
                        </a>
                    </div>
                    <div className={style.footer}>
                        <a href='https://t.me/I_am_Olja'>
                            <img src={telegramImage} alt="telegram" className={style.icon}/>
                        </a>
                    </div>
                    <div className={style.footer}>
                        <a href='https://github.com/ole4ka140592'>
                            <img src={githubImage} alt="github" className={style.icon}/>
                        </a>
                    </div>
                </div>
